...
import '../NearEvents/navigation_screen.dart';
import 'my_page.dart';
...
class detailPage2 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    //Trying only
    var thingNeeded = [needs1, need2, need3, need4];

    var ingredientList = [ingredients1, ingredients2, ingredients3];
                    ...
                    children: [
                      Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                                height: 5, width: 35, color: Colors.black12)
                          ],
                        ),
                      ),
                      Text(title,
                          style: Theme.of(context)
                              .textTheme
                              .headline4!
                              .copyWith(color: AppColors.bigtextColor)),
                      ...
                      ListView.builder(
                          ...
                          itemBuilder: (context, index) =>
                              Needs(context, index, thingNeeded)),
                      const Padding(
                        padding: EdgeInsets.symmetric(vertical: 15),
                        child: Divider(
                          height: 4,
                      ...
                      ListView.builder(
                          ...
                          itemCount: 3,
                          itemBuilder: (context, index) =>
                              steps(context, index, ingredientList)),
                      const SizedBox(
                        height: 10,
                      ),
                      Row(
